          ...
          <div class="flex-first">
            ...
            <div class="form">
              <div class="main-logo">
                ...
                <span class="text02"><a>회원가입</a></span>
              </div>
              <div class="input3">
                <div class="div-placeholder">
                  <span class="text04"><span>이메일</span></span>
                </div>
              </div>
              <div class="input3asdr1">
                <div class="div-placeholder1">
                  <span class="text06">비밀번호</span>
                </div>
              </div>
              <button class="button1">
                <span class="text07"><span>로그인</span></span>
              </button>
            </div>
            <div class="section">
              <span class="text09">
              ...
              <div src="/playground_assets/svg1537-122b.svg" alt="svg1537" class="facebook-svg" />
              <div src="/playground_assets/svg1537-tfws.svg" alt="svg1537" class="kakao-svg1" />
              <div src="/playground_assets/svg1537-dh7p.svg" alt="svg1537" class="naver-svg2" />
            </div>
            <span class="text11">
